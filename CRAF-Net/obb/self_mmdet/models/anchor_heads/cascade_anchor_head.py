...
from obb.self_mmdet.core import multiclass_nms
from obb.self_mmdet.core import (anchor_target, anchor_target_rbbox, cascade_target_rbbox)
...
class CascadeAnchorHeadRbbox(nn.Module):
    ...
    def loss(self,
        ...
        if assigner_type == 'MaxIoUAssignerCy':
            ...
            cls_reg_targets = cascade_target_rbbox(
                anchor_list,
                valid_flag_list,
                gt_bboxes,
                gt_masks,
